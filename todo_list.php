      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a class="active" href="todo_list.php" >
                          <i class="fa fa-th"></i>
...
<body onload="getList()">
	...
	<script type="text/javascript" src="script.js"></script>
                              ...
                              <div class=" add-task-row">
                                  <input class="form-control" type="text" id="user" placeholder="Write A New Task Here...."><button type="button" class="btn btn-success btn-sm pull-left" onclick="addUser(); loadPage();">Add New Task</button>
                              </div>
                          </div>
<script type="text/javascript" src="Template/assets/js/jquery.min.js"></script>
<script type="text/javascript" src="script.js"></script>
