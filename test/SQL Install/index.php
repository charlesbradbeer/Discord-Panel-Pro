...
<head>
    ...
    <title>Install DiscordPanel SQL</title>
...
<body onload="getList()">
	<div class="mainContainer">
		<header>
		  <center><h1><font color="white">Install the DiscordPanel Database</font></h1></center>
		</header>
		<div class="container" ... onsubmit="return checkForm(this);">
			<form action="database.php" class="form-control">
            <center><button type="submit" class="btn btn-primary buttonArea">Install</button>
			</form>
            <br>
            <br>
            <p><font color="white">By clicking the button above you will be reloaded to a new page to state weather the database installed or not.</font></p>
			<p><font color="white">Before clicking Submit make sure you have filled out the config file in "Template/config.php"</font></p></center>
		</div>
	</div>
	<br>
	<br>
