      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><center></center></p>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> License Settings</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
<?php
$success = false;
...
echo "<h4>Your current license: $licensekey</h4>";
...
<br><br><br>
<div class="wrapper">
<p>To update or change your lisence please contact us on discord or at Hostable.co and we will talk you though doing it.</p>
</div>
		</section><! --/wrapper -->
      </section>
