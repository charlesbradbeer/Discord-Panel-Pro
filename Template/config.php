...
$panelurl = 'https://dev.discordpanel.xyz/'; // Panel URL with "/"
$websiterememberme = 'true'; // Website remember me option... true = On. false = off
$clientID = ''; // Put your Discord Client ID for logging in.
$clientSecret = ''; // Put your Discord Client Secret for logging in.
$redirectURI = 'https://dev.discordpanel.xyz/callback/login.php'; // Put your Discord Redirect URI for logging in. (Should be https://url.tld/callback/login.php)
$twitter = 'twitter'; // Your Twitter ID
