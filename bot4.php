      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> <?php echo $bot4; ?> Panel</h3>
          		...
          		<div class="col-md-12">
          			<div class="white-panel pn">
	                	<div class="panel-heading">
	                        <div class="pull-left"><h5><i class="fa fa-tasks"></i> <?php echo $bot4; ?> Controls</h5></div>
	                        <br>
	                 	</div>
				  		<div class="custom-check goleft mt">
						<h5> About <?php echo $bot4; ?>:</h5>
						<p><?php echo $Bot4about; ?></p>
<br>
<br>
<br>
<br>
   ...
   <center><input type="submit" name="lobby-stop" value="Stop" class="btn btn-success">  <input type="submit" name="lobby-restart" value="Start" class="btn btn-danger"/></center>
          	             ...
          	             <div>
                      		<div class="white-panel pn">
                      			...
                      			<iframe src="Template/homepanel4.php" frameBorder="0" height="300"></iframe>
                      		</div>
                      	</div><!-- /col-md-4 --><br>
<br>
<br>
